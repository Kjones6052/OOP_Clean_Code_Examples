...
from shopping_item import Item
# Defining a shopping cart class that can hold multiple items and manage cart operations
class ShoppingCart:
    def __init__(self):
        self.items = {}
    ...
    def remove_item(self, item_name):
        if item_name in self.items:
            ...
            print(f"{item_name} was removed from the cart.")
        else:
