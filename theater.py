...
# Define a class Theater with functions to manage seats in theater

class Theater:
    def __init__(self, rows, seats_per_row):
        self.seating = [[{'row': row, 'numer': seat, 'reserved': False} for seat in range(1, seats_per_row + 1)] for row in range(1, rows + 1)]
